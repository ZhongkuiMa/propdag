...
[![Version](https://img.shields.io/github/v/tag/ZhongkuiMa/propdag?sort=semver)](https://github.com/ZhongkuiMa/propdag/releases)
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for development setup, testing procedures, code quality standards, pull request guidelines, and release process.
